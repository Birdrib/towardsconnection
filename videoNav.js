...
var vidid = ["loopback", "l_ind", "d_ind", "l_coord", "d_coord", "l_org", "d_org", "l_reor", "d_reor", "l_con", "end"]; //first video is transition from end back to beginning
var gifid = ["startGIF", "wait_l_ind", "wait_d_ind", "wait_l_coord", "wait_d_coord", "wait_l_org", "wait_d_org", "wait_l_reor", "wait_d_reor", "wait_l_con", "wait_end"]; //first gif is start gif
